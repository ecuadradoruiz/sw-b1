...
const getCharacter = async (urlCharacter) => {
    ...
    console.log(data);
*/
    data = {"name":"Luke Skywalker","height":"172","mass":"77","hair_color":"blond","skin_color":"fair","eye_color":"blue","birth_year":"19BBY","gender":"male","homeworld":"https://swapi.dev/api/planets/1/","films":["https://swapi.dev/api/films/1/","https://swapi.dev/api/films/2/","https://swapi.dev/api/films/3/","https://swapi.dev/api/films/6/"],"species":[],"vehicles":["https://swapi.dev/api/vehicles/14/","https://swapi.dev/api/vehicles/30/"],"starships":["https://swapi.dev/api/starships/12/","https://swapi.dev/api/starships/22/"],"created":"2014-12-09T13:50:51.644000Z","edited":"2014-12-20T21:17:56.891000Z","url":"https://swapi.dev/api/people/1/"};
...
const formatDataCharacter = (data) => {
    let dataFormated =  {
        ...
        img: "assets/images/people/" + data.url.replace("https://swapi.dev/api/people/", "").split('/')[0] + ".jpg",
        height: data.height,
        gender: data.gender,
        mass: data.mass,
        species: mapOptionsCharacters(data.species, 'species'),
        starships: mapOptionsCharacters(data.starships, 'starships'),
        films: mapOptionsCharacters(data.films, 'films')
...
const mapOptionsCharacters = (options, option) => {
    optionsFormated = [];
...
const formatCharacterDetail = (character) => {
    ...
    let species = formatOptionsCharacter ('species', character.species);
    let films = formatOptionsCharacter ('films', character.films);
    let starships = formatOptionsCharacter ('starships', character.starships);
...
const formatOptionsCharacter = (option, options) => {
    let htmlStructure = "";
    if(options.length > 0){
...
const addEventListenerToOptionsCharacter = (option, options) => {
    console.log(options);
